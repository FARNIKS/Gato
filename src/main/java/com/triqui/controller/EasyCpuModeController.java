...
public class EasyCpuModeController {

    @FXML
    private ImageView space00, space01, space02, space10, space11, space12, space20, space21, space22, imgRestart, imgBackground,imgMusic,imgHome,imgExit,imgMode;
    @FXML
    ...
    public EasyCpuModeController(){
        String musicFile = "/media/CpuEasy.mp3";
    ...
    private void easyCpuLogic(int row, int col) {
        ...
        boardGame[rows][cols] = initialPlayer;
        ImageView imageView = imgMap[rows][cols];
        Image imageCpuO = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/Player2CpuO.png")));
        imageView.setImage(imageCpuO);
        map[rows][cols].setDisable(true);
    ...
    private void winsLogic() {
        ...
        if (img00 == 2 && img01 == 2 && img02 == 2 ||
            ...
            addImageCurrentStatusGame("/img/EasyCpuWins.gif");
    ...
    private void addImageCurrentStatusGame(String url) {
        Image currentImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream(url)));
