...
public class ImpossibleCpuModeController {
    @FXML
    ...
    public ImpossibleCpuModeController(){
        String musicFile = "/media/CpuImpossible.mp3";
    ...
    private void impossibleCpuLogic(int row, int col) {
        ...
        if (img00==2&&img11==0||img02==2&&img11==0||img22==2&&img11==0||img20==2&&img11==0||img01==0&&img11==0||img12==0&&img11==0||img21==0&&img11==0||img10==0&&img11==0) {
            addImageOToBoard(1,1);
        }
        //Defensas medio externas
        else if (img11==2&&img01==2&&img10==2&&img00==0&&img22==2) {
            addImageOToBoard(0,0);
        }else if (img11==2&&img01==2&&img10==2&&img00==2&&img22==0) {
            addImageOToBoard(2,2);
        }else if (img11==2&&img01==2&&img12==2&&img02==0&&img20==2) {
            addImageOToBoard(0,2);
        }else if (img11==2&&img01==2&&img12==2&&img02==2&&img20==0) {
            addImageOToBoard(2,0);
        }else if (img11==2&&img12==2&&img21==2&&img00==0&&img22==2) {
            addImageOToBoard(0,0);
        }else if (img11==2&&img12==2&&img21==2&&img00==2&&img22==0) {
            addImageOToBoard(2,2);
        }else if (img11==2&&img21==2&&img10==2&&img20==0&&img02==2) {
            addImageOToBoard(2,0);
        }else if (img11==2&&img21==2&&img10==2&&img20==2&&img22==0) {
            addImageOToBoard(2,2);
        }
    //Mas defensas
        else if (img01==2&&img22==2&&img20==2&&img21==0) {
            addImageOToBoard(2,1);
        }else if (img12==2&&img00==2&&img20==2&&img10==0) {
            addImageOToBoard(1,0);
        }else if (img21==2&&img00==2&&img02==2&&img01==0) {
            addImageOToBoard(0,1);
        }else if (img10==2&&img02==2&&img22==2&&img12==0) {
            addImageOToBoard(1,2);
        }
        //Defensas esquineras
        else if (img00==2&&img22==2&&img02==2&&img01==0) {
            addImageOToBoard(0,1);
        }else if (img00==2&&img22==2&&img02==2&&img12==0) {
            addImageOToBoard(1,2);
        }else if (img02==2&&img22==2&&img20==2&&img12==0) {
            addImageOToBoard(1,2);
        }else if (img02==2&&img22==2&&img20==2&&img21==0) {
            addImageOToBoard(2,1);
        }else if (img00==2&&img20==2&&img22==2&&img21==0) {
            addImageOToBoard(2,1);
        }else if (img00==2&&img20==2&&img22==2&&img10==0) {
            addImageOToBoard(1,0);
        }else if (img20==2&&img00==2&&img02==2&&img01==0) {
            addImageOToBoard(0,1);
        }else if (img20==2&&img00==2&&img02==2&&img10==0) {
            addImageOToBoard(1,0);
        }
        //Defensas extras medio
        else if (img00==2&&img22==2&&img02==2&img01==0) {
            addImageOToBoard(0,1);
        }else if (img00==2&&img11==1&&img22==2&img21==0) {
            addImageOToBoard(2,1);
        }
        //Defensas medias superior
        else if (img02==2&&img10==2&&img00==0&&img11==1) {
            addImageOToBoard(0,0);
        }else if (img02==2&&img10==2&&img20==0&&img11==1) {
            addImageOToBoard(2,0);
        }else if (img00==2&&img12==2&&img02==0&&img11==1) {
            addImageOToBoard(0,2);
        }else if (img00==2&&img12==2&&img22==0&&img11==1) {
            addImageOToBoard(2,2);
        }
        //Defensas medias derecha
        else if (img01==2&&img22==2&&img02==0&&img11==1) {
            addImageOToBoard(0,2);
        }else if (img01==2&&img22==2&&img00==0&&img11==1) {
            addImageOToBoard(0,0);
        }else if (img02==2&&img21==2&&img22==0&&img11==1) {
            addImageOToBoard(2,2);
        }else if (img02==2&&img21==2&&img20==0&&img11==1) {
            addImageOToBoard(2,0);
        }
        //Defensas medias abajo
        else if (img20==2&&img12==2&&img22==0&&img11==1) {
            addImageOToBoard(2,2);
        }else if (img20==2&&img12==2&&img02==0&&img11==1) {
            addImageOToBoard(0,2);
        }else if (img22==2&&img10==2&&img20==0&&img11==1) {
            addImageOToBoard(2,0);
        }else if (img22==2&&img10==2&&img00==0&&img11==1) {
            addImageOToBoard(0,0);
        }
        //Defensas medias Izquierda
        else if (img20==2&&img01==2&&img00==0&&img11==1) {
            addImageOToBoard(0,0);
        }else if (img20==2&&img01==2&&img02==0&&img11==1) {
            addImageOToBoard(0,2);
        }else if (img00==2&&img21==2&&img20==0&&img11==1) {
            addImageOToBoard(2,0);
        }else if (img00==2&&img21==2&&img22==0&&img11==1) {
            addImageOToBoard(2,2);
        }
        ...
        // Defensa medio
        else if (img11==2&&img01==2&&img10==2&&img21==0) {
            addImageOToBoard(2,1);
        }else if (img11==2&&img01==2&&img10==2&&img12==0) {
            addImageOToBoard(1,2);
        }else if (img11==2&&img01==2&&img12==2&&img10==0) {
            addImageOToBoard(1,0);
        }else if (img11==2&&img01==2&&img12==2&&img21==0) {
            addImageOToBoard(2,1);
        }else if (img11==2&&img12==2&&img21==2&&img10==0) {
            addImageOToBoard(1,0);
        }else if (img11==2&&img12==2&&img21==2&&img01==0) {
            addImageOToBoard(0,1);
        }else if (img11==2&&img21==2&&img10==2&&img12==0) {
            addImageOToBoard(1,2);
        }else if (img11==2&&img21==2&&img10==2&&img01==0) {
            addImageOToBoard(0,1);
        }

        //defensas esquinas
        //Esquinero izquierdo superior
        else if (img00==2&&img20==2&&img10==0&&img01==0) {
            addImageOToBoard(1,0);
        }else if (img00==2&&img02==2&&img10==0&&img01==0) {
            addImageOToBoard(0,1);
        }
        //Esquinero derecho superior
        else if (img02==2&&img00==2&&img01==0&&img12==0) {
            addImageOToBoard(0,1);
        }else if (img02==2&&img22==2&&img01==0&&img12==0) {
            addImageOToBoard(1,2);
        }
        //Espinero inferior derecho
        else if (img22==2&&img02==2&&img21==0&&img12==0) {
            addImageOToBoard(1,2);
        }else if (img20==2&&img22==2&&img21==0&&img12==0) {
            addImageOToBoard(2,1);
        }
        //Esquienro inferior izquierdo
        else if (img20==2&&img02==2&&img10==0&&img21==0) {
            addImageOToBoard(1,0);
        }else if (img20==2&&img22==2&&img10==0&&img21==0) {
            addImageOToBoard(1,2);
        }
        //Bugs diagonales
        else if (img01==2&&img12==2&&img22==0) {
            addImageOToBoard(2,2);
        }else if (img01==2&&img10==2&&img20==0) {
            addImageOToBoard(2,0);
        }else if (img21==2&&img10==2&&img00==0) {
            addImageOToBoard(0,0);
        }else if (img21==2&&img12==2&&img02==0) {
            addImageOToBoard(0,2);
        }
        //logica ganar cpu
        //Filas
        else if (img00==1&&img01==1&&img02==0){
            addImageOToBoard(0,2);
        }else if (img10==1&&img11==1&&img12==0){
            addImageOToBoard(1,2);
        }else if (img20==1&&img21==1&&img22==0){
            addImageOToBoard(2,2);
        }else if (img00==0&&img01==1&&img02==1){
            addImageOToBoard(0,0);
        }else if (img10==0&&img11==1&&img12==1){
            addImageOToBoard(1,0);
        }else if (img20==0&&img21==1&&img22==1){
            addImageOToBoard(2,0);
        }else if (img00==1&&img01==0&&img02==1){
            addImageOToBoard(0,1);
        }else if (img10==1&&img11==0&&img12==1){
            addImageOToBoard(1,1);
        }else if (img20==1&&img21==0&&img22==1){
            addImageOToBoard(2,1);
        }
        //Columnas
        else if (img00==1&&img10==1&&img20==0){
            addImageOToBoard(2,0);
        }else if (img01==1&&img11==1&&img21==0){
            addImageOToBoard(2,1);
        }else if (img02==1&&img12==1&&img22==0){
            addImageOToBoard(2,2);
        }else if (img00==0&&img10==1&&img20==1){
            addImageOToBoard(0,0);
        }else if (img01==0&&img11==1&&img21==1){
            addImageOToBoard(0,1);
        }else if (img02==0&&img12==1&&img22==1){
            addImageOToBoard(0,2);
        }else if (img00==1&&img10==0&&img20==1){
            addImageOToBoard(1,0);
        }else if (img01==1&&img11==0&&img21==1){
            addImageOToBoard(1,1);
        }else if (img02==1&&img12==0&&img22==1){
            addImageOToBoard(1,2);
        }
        //Diagonales
        else if (img00==1&&img11==1&&img22==0){
            addImageOToBoard(2,2);
        }else if (img00==0&&img11==1&&img22==1){
            addImageOToBoard(0,0);
        }else if (img02==1&&img11==1&&img20==0){
            addImageOToBoard(2,0);
        }else if (img02==0&&img11==1&&img20==1){
            addImageOToBoard(0,2);
        }else if (img00==1&&img11==0&&img22==1){
            addImageOToBoard(1,1);
        } else if (img02==1&&img11==0&&img20==1) {
            addImageOToBoard(1,1);
        }

        //Bloqueo cpu
        // Filas
        else if (img00==2&&img01==2&&img02==0){
                addImageOToBoard(0,2);
        ...
        else if (img11==2&&img02==0) {
            addImageOToBoard(0,2);
        }else if (img11==2&&img00==0) {
            addImageOToBoard(0,0);
        }else if (img11==2&&img22==0) {
            addImageOToBoard(2,2);
        }else if (img11==2&&img20==0) {
            addImageOToBoard(2,0);
        }
        else {
            if (contTurnCpu <5) {
                ...
                System.out.println("Po" + rows + "," + cols);
    ...
    private void winsLogic() {
        ...
        if (img00==2&&img01==2&&img02==2||
            ...
            addImageCurrentStatusGame("/img/ImpossibleCpuWins.gif");
